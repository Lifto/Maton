...
### Changed
- `Maton.md` now includes full operational protocol (core purpose, operating principles, response format, self-improvement guidelines).
- `maton ask` errors on both missing directory and missing `Maton.md` (no silent fallback).
